...
const Signup = () => {
  ...
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col-reverse items-center justify-center">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col mb-16 md:mb-0 items-center text-center">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Start your journey with agoraX</h1>
      <p class="mb-8 leading-relaxed text-white text-4xl">Register your enterprise and get going already!</p>
      <div class="flex w-full justify-center items-end ">
        <div class="relative mr-4 md:w-full lg:w-full xl:w-1/2 w-2/4">
          <label for="hero-field" class="leading-7 text-gray-100 text-2xl">Email Address</label>
        ...
        <button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg"><Link href="/services/setup/">Start</Link></button>
      </div>
